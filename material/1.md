...
## 範例 1-6(選單-具有獨立網址) 
index.html、Page0.html~Page5.html 同範例 1-4
commom.js
```javascript=
...
## 範例 1-11(選單事件-使用 removeEventListener 移除事件) 
...
- 使用 removeEventListener 方法可以移除綁定事件。 
- 需綁定同一個function
- 綁定的事件為redirect到某另外一頁
